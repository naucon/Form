...
/**
 * Form Helper Field Password
 *
 * @package     Form
 * @subpackage  Helper
 * @author      Sven Sanzenbacher
 */
class FormHelperFieldPassword extends AbstractFormHelperField
{
    /**
    ...
    {
        $htmlElement = new HtmlInputPassword($this->getProperty()->getFormName(), $this->getProperty()->getFormValue());
